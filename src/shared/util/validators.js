...
export const VALIDATOR_MIN = val => ({ type: VALIDATOR_TYPE_MIN });
export const VALIDATOR_MAX = val => ({ type: VALIDATOR_TYPE_MAX });
export const VALIDATOR_EMAIL = val => ({ type: VALIDATOR_TYPE_EMAIL });
export const VALIDATOR_PASSWORD = val => ({ type: VALIDATOR_TYPE_PASSWORD });
